(function(){
	...
	var cssDepend = {	//
		'comments' : commentUrl +'/static/css/new-comments.css?20191213',		//
	...
	var jsDepend = {
		...
		'mylib' : commentUrl +'/dist/js/common.js?201912131327',	
		...
		'um' : {	//百度编辑器js文件
			...
			'comment_config' : commentUrl +'/static/um/comment.config.js?201805081257',
			'umeditor' : commentUrl +'/static/um/umeditor.js?201807181649',
			'lang' : commentUrl +'/static/um/lang/zh-cn/zh-cn.js?20171216',
		},
		'comments' : commentUrl +'/static/js/comments-new.js?20191213',	//评论插件主文件
